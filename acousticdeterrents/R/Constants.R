...
notapproveESA.note <- "<b>Certificate cannot be issued </b> for Cook Inlet beluga or insular false killer whale because using non-impulsive acoustic deterrents are not included in the recommended specific measures for these ESA-listed marine mammals."
