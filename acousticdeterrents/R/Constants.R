...
approve.note <- "<b>Your device meets NMFS criteria</b>. Click below to download a certificate."
notapprove.note <- "<b>Your device DOES NOT meet NMFS criteria</b>. In order to download a certificate, you will need an acoustic deterrent that fits the guidelines"
